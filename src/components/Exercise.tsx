...
const Exercise: FC<Props> = ({ timeInterval }) => {
  const { timeframes }: Activity = data[3] || {
    timeframes: {
  ...
  return (
    <div
      className={`row-span-1 h-[160px] rounded-[1rem] bg-[url(../images/icon-exercise.svg)] bg-LimeGreen bg-no-repeat flex items-end sm:h-[244px] md:col-span-2 lg:col-span-1`}
      style={{
