...
const SelfCare: FC<Props> = ({ timeInterval }) => {
  const { timeframes }: Activity = data[5] || {
    timeframes: {
  ...
  return (
    <div
      className={`row-span-1 h-[160px] rounded-[1rem] bg-[url(../images/icon-self-care.svg)] bg-SoftOrange bg-no-repeat flex items-end sm:h-[244px] md:col-span-3 lg:col-span-1`}
      style={{
